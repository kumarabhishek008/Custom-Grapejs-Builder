...
export default (domc) => {
    ...
    domc.addType('container', {
        model: defaultModel.extend({
            ...
            isComponent(el) {
                if(el && el.classList && (el.classList.contains('container') || el.classList.contains('container-fluid') || el.classList.contains('gr-container-xl') || el.classList.contains('gr-container') || el.classList.contains('gr-container-lg'))) {
