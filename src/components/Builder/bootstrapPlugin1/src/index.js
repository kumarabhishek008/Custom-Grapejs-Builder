...
import loadPaymentMethod from './payment-method';
...
const loadCss = editor => {
  editor.Config.canvasCss += `
    ...
    .gjs-dashed .row,
    .gr-container, .gjs-dashed .col, .gjs-dashed [class^="col-"] {
...
export default grapesjs.plugins.add('grapesjs-blocks-bootstrap4-1', (editor, opts = {}) => {
  ...
  const default_labels = {
    ...
    type_button: 'Button',
    // strip payment 
    strip_payment : 'Strip Payment',
    trait_stripKey : 'Strip Key',
    trait_successUrl: ' Success URL',
    trait_errorUrl : 'Error URL',
    trait_productSku : 'Price Id',
  };
